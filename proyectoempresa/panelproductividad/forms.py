...
class RegistroProductividadTrabajadorForm(forms.ModelForm):
    """Formulario para que trabajadores registren su propia productividad (sin campo trabajador)"""
    class Meta:
        model = RegistroProductividad
        fields = [
            'fecha', 'hora_inicio', 'hora_finalizacion',
            'cortado', 'marcado_piezas', 'costura', 'armado', 
            'instalacion', 'sillas_realizadas', 'tapizado_puertas', 'tapizado_techo',
            'observaciones'
        ]
